    ...
    >
      ...
      {showCart ? (
        ...
        <Routes>
          ...
          <Route path="/about" element={<h1 style={{color:"black"}} >About Page</h1>} />
          <Route path="/products" element={<h1 style={{color:"black"}}>Products Page</h1>} />
          <Route path="/contact" element={<h1 style={{color:"black"}} >Contact Page</h1>} />
        </Routes>
      )}
    </div>
  );
